...
namespace System.Speech.Synthesis
{
    ...
    public class PromptStyle
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="System.Speech.Synthesis.PromptStyle" /> class.</summary>
        public PromptStyle()
        {
        }

        /// <summary>Initializes a new instance of the <see cref="System.Speech.Synthesis.PromptStyle" /> class and specifies the setting for the speaking rate of the style.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="System.Speech.Synthesis.PromptStyle" /> class and specifies the setting for the speaking volume of the style.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="System.Speech.Synthesis.PromptStyle" /> class and specifies the setting for the emphasis of the style.</summary>
