...
{
    /// <summary>Returns data from the <see cref="System.Speech.Synthesis.SpeechSynthesizer.StateChanged" /> event.</summary>
    public class StateChangedEventArgs : EventArgs
    {
        ...
        /// <summary>Gets the state of the <see cref="System.Speech.Synthesis.SpeechSynthesizer" /> before the <see cref="System.Speech.Synthesis.SpeechSynthesizer.StateChanged" /> event.</summary>
