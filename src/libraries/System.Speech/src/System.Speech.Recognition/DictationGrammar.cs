...
namespace System.Speech.Recognition
{
    ...
    public class DictationGrammar : Grammar
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="System.Speech.Recognition.DictationGrammar" /> class for the default dictation grammar provided by Windows Desktop Speech Technology.</summary>
        public DictationGrammar()
            : base(_defaultDictationUri, null, null)
        {
        }

        /// <summary>Initializes a new instance of the <see cref="System.Speech.Recognition.DictationGrammar" /> class with a specific dictation grammar.</summary>
        ...
        /// <summary>Adds a context to a dictation grammar that has been loaded by a <see cref="System.Speech.Recognition.SpeechRecognizer" /> or a <see cref="System.Speech.Recognition.SpeechRecognitionEngine" /> object.</summary>
