...
namespace Microsoft.Interop.JavaScript
{
    ...
    public sealed class JSExportGenerator : IIncrementalGenerator
    {
        ...
        private static readonly string s_generatorName = typeof(JSExportGenerator).FullName!;

        /// <summary> Assembly location, used for diagnostics </summary>
#pragma warning disable IL3000
        private static readonly string s_generatorLocation = typeof(JSExportGenerator).Assembly.Location;
#pragma warning restore IL3000
        ...
        public void Initialize(IncrementalGeneratorInitializationContext context)
        {
            ...
            context.RegisterSourceOutput(generated,
                ...
                {
                    var operation = SourceGeneratorsEventSource.Log.StartGeneratorPhase(s_generatorName, s_generatorLocation, nameof(IncrementalGeneratorInitializationContext.RegisterSourceOutput));
                    try
                    {
        ...
        {
            var operation = SourceGeneratorsEventSource.Log.StartGeneratorPhase(s_generatorName, s_generatorLocation, nameof(GenerateSource));
            try
            {
