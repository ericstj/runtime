...
namespace System
{
    public class BinaryData
    {
        ...
        public static BinaryData FromObjectAsJson<T>(T jsonSerializable, JsonSerializerOptions? options = default) => default(BinaryData);
        ...
        public byte[] ToArray() => default(byte[]);
        public System.ReadOnlyMemory<byte> ToMemory() => default(ReadOnlyMemory<byte>);
        public T ToObjectFromJson<T>(JsonSerializerOptions? options = default) => default(T);
